...
class Datacard extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['event_type', 'event_magnitude', 'event_centre', 'event_cause', 'event_duration', 'location_state', 'location_district', 'location_localbody', 'location_placename','location_region','location_ecology', 'damage_house_building_value', 'damage_house_shed_value', 'damage_infra_road_unit', 'damage_infra_road_value', 'damage_infra_bridge_unit', 'damage_infra_bridge_value', 'damage_infra_electricity_unit', 'damage_infra_electricity_value', 'damage_infra_water_unit', 'damage_infra_water_value', 'damage_infra_sewage_unit', 'damage_infra_sewage_value', 'damage_infra_communication_unit', 'damage_infra_communication_value', 'damage_infra_medical_unit', 'damage_infra_medical_value', 'damage_infra_educational_unit', 'damage_infra_educational_value', 'damage_infra_institutions_unit', 'damage_infra_institutions_value', 'damage_infra_industries_unit', 'damage_infra_industries_value', 'total_loss_value_rs', 'total_loss_value_usd', 'metadata_collected_by', 'metadata_verified_by', 'effect_loss_land_unit', 'effect_loss_agri_unit', 'effect_loss_livestock_unit'], 'string', 'max' => 255],
        ];
    }
    ...
    public function getDropdown_eventType()
    {
        return [
            'accident' => 'Accident',
            'avalanche' => 'Avalanche',
            'biological disaster' => 'Biological Disaster',
