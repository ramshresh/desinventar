...
class DatacardSearch extends Datacard
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'event_type', $this->event_type])
            ...
            ->andFilterWhere(['like', 'damage_house_building_value', $this->damage_house_building_value])
            ->andFilterWhere(['like', 'damage_house_shed_value', $this->damage_house_shed_value])
            ->andFilterWhere(['like', 'damage_infra_road_unit', $this->damage_infra_road_unit])
            ->andFilterWhere(['like', 'damage_infra_road_value', $this->damage_infra_road_value])
            ->andFilterWhere(['like', 'damage_infra_bridge_unit', $this->damage_infra_bridge_unit])
            ->andFilterWhere(['like', 'damage_infra_bridge_value', $this->damage_infra_bridge_value])
            ->andFilterWhere(['like', 'damage_infra_electricity_unit', $this->damage_infra_electricity_unit])
            ->andFilterWhere(['like', 'damage_infra_electricity_value', $this->damage_infra_electricity_value])
            ->andFilterWhere(['like', 'damage_infra_water_unit', $this->damage_infra_water_unit])
            ->andFilterWhere(['like', 'damage_infra_water_value', $this->damage_infra_water_value])
            ->andFilterWhere(['like', 'damage_infra_sewage_unit', $this->damage_infra_sewage_unit])
            ->andFilterWhere(['like', 'damage_infra_sewage_value', $this->damage_infra_sewage_value])
            ->andFilterWhere(['like', 'damage_infra_communication_unit', $this->damage_infra_communication_unit])
            ->andFilterWhere(['like', 'damage_infra_communication_value', $this->damage_infra_communication_value])
            ->andFilterWhere(['like', 'damage_infra_medical_unit', $this->damage_infra_medical_unit])
            ->andFilterWhere(['like', 'damage_infra_medical_value', $this->damage_infra_medical_value])
            ->andFilterWhere(['like', 'damage_infra_educational_unit', $this->damage_infra_educational_unit])
            ->andFilterWhere(['like', 'damage_infra_educational_value', $this->damage_infra_educational_value])
            ->andFilterWhere(['like', 'damage_infra_institutions_unit', $this->damage_infra_institutions_unit])
            ->andFilterWhere(['like', 'damage_infra_institutions_value', $this->damage_infra_institutions_value])
            ->andFilterWhere(['like', 'damage_infra_industries_unit', $this->damage_infra_industries_unit])
            ->andFilterWhere(['like', 'damage_infra_industries_value', $this->damage_infra_industries_value])
            ...
            ->andFilterWhere(['like', 'metadata_source_date', $this->metadata_source_date])
