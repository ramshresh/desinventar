...
//$this->title = 'Showing Datacard: ' . $model->data_card_no . ' (' . $model->event_type . ', ' . $model->event_cause . ' @ ' . $model->location_district . ' - ' . $model->event_date . ')';
...
<div class="datacard-view">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <?= $form->field($model, 'data_card_no')->textInput(['readonly' => true])->label(false) ?>
                        </td>
                        <td colspan="1">
                            Event Date :
                        </td>
                        <td colspan="1">
                            <?= $form->field($model, 'event_date')->textInput(['readonly' => true])->label(false) ?>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    ...
                    <tr>
                        ...
                        <td><?= $form->field($model, 'damage_house_building_value')->textInput(['readonly' => true])->label(false) ?></td>
                    </tr>
                    <tr>
                        <td>Shed</td>
                        ...
                        <td><?= $form->field($model, 'damage_house_shed_value')->textInput(['readonly' => true])->label(false) ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    <p>
        ...
        <!--        .(\Yii::$app->user->can('update-datacard',['model'=>$model]))?'':'disabled'-->
        <?= Html::a('Update it', ['update', 'id' => $model->id],
            [
                'class' => 'btn btn-primary',
                'disabled' => (\Yii::$app->user->can('update-datacard', ['model' => $model])) ? false : true
            ]
        ) ?>
        ...
        <?= Html::a('Delete', ['delete', 'id' => $model->id],
            [
                ...
                'disabled' => (\Yii::$app->user->can('delete-datacard', ['model' => $model])) ? false : true,
                'data' => [
