...
<div class="datacard-form">
    ...
    <?php $form = ActiveForm::begin(['options'=>['class'=>'warn-lose-changes']]); ?>
    <div class="row">
        <div class="col-md-6">
            <h5 class="text-danger">1. Disaster</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <tbody>
                    <tr>
                        <td colspan="1" >
                            <strong class="text-primary">Data Card No :</strong>
                        </td>
                        <td colspan="1">
                            <?= $form->field($model, 'data_card_no')->textInput()->label(false) ?>
                        </td>
                        <td colspan="1">
                           <strong class="text-primary"> Event Date :</strong>
                        </td>
                        <td colspan="1">
                            <?= $form->field($model, 'event_date')
                                ...
                                [
                                    ...
                                    'options' => ['placeholder' => 'Select event date ...'],
                                    'pluginOptions' => [
                                        'format' => 'yyyy-mm-dd',
                                        'todayHighlight' => true
                                    ]
                    ...
                    <tr>
                        <td colspan="2" rowspan="2">
                            <strong class="text-primary">Event Type:</strong>
                    ...
                    <tr>
                        <td colspan="1"><strong class="text-primary">Cause</strong></td>
                        <td colspan="1">
                    ...
                    <tr>
                        <td colspan="1" ><strong class="text-primary">Description</strong></td>
            ...
            <div class="row">
                <div class="col-md-4">
                    <h5 class="text-danger">2. Location</h5>
                </div>
                <div class="col-md-8">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <tbody>
                    <tr>
                        <td colspan="1"><strong class="text-primary">District</strong></td>
                        <td colspan="1"><?= $form->field($model, 'location_district')
                                ->dropDownList(
                                    $districts, ['id' => 'district-id', 'prompt' => 'Select...']
                                )->label(false);
                            ?></td>
                        <td colspan="1"><strong class="text-primary">Local Body</strong></td>
...
-->
                        <td colspan="1"><strong class="text-primary">Ward No</strong></td>
                        <td colspan="1"><?= $form->field($model, 'location_wardno')->widget(\kartik\depdrop\DepDrop::classname(), [
                                'options' => ['id' => 'wardno-id'],
                                'data' => isset($wardnos) ? $wardnos : [],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                    'depends' => ['localbody-id'],
                                    'placeholder' => 'Select...',
                                    'url' => \yii\helpers\Url::to(['/datacard/location/ward-no'])
                                ],
                                'pluginEvents' => [
                                    "depdrop:init" => "function() { console.log('depdrop:init'); }",
                                    "depdrop:ready" => "function() { console.log('depdrop:ready'); }",
                        ...
                        <td colspan="1"><strong class="text-primary">Village/Tole</strong></td>
                        <td colspan="1"><?= $form->field($model, 'location_placename')->textInput()->label(false) ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            <h5 class="text-danger">3. Effect on People </h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <thead>
                    <th></th>
            ...
            <h5 class="text-danger">4. Effect on Land/Agriculture </h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <thead>
                    <th>Loss</th>
        ...
        <div class="col-md-6">
            <h5 class="text-danger">5. Effect on Houses</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <thead>
                    <th>Type</th>
            ...
            <h5 class="text-danger">6. Effect on Infrastructures</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <thead>
                    <th>Facility</th>
            ...
            <h5 class="text-danger">7. Total Loss Value</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <tbody>
                    <tr>
            ...
            <h5 class="text-danger">8. Comment</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <tbody>
                    <tr>
            ...
            <h5 class="text-danger">9. Metadata</h5>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-highlight">
                    <tbody>
                    <tr>
                        <td colspan="1"><strong class="text-primary">Data/Information Source:</strong></td>
                        <td colspan="4"><?= $form->field($model, 'metadata_source')->textInput()->label(false) ?></td>
                        <td colspan="1"><strong class="text-primary">Date:</strong></td>
                        <td colspan="4"><?= $form->field($model, 'metadata_source_date')
                                ->widget(\kartik\date\DatePicker::className(),
                                    [
                                        //'name' => 'metadata_source_data',
                                        //'value' => date('yyyy-MM-dd', strtotime('+2 days')),
                                        'options' => ['placeholder' => 'Select event date ...'],
                                        'pluginOptions' => [
                                            'format' => 'yyyy-mm-dd',
                    ...
                    <tr>
                        <td colspan="1"><strong class="text-primary">Collected By:</strong></td>
                        <td colspan="4"><?= $form->field($model, 'metadata_collected_by')->textInput()->label(false) ?></td>
                        <td colspan="1"><strong class="text-primary">Date:</strong></td>
                        <td colspan="4"><?= $form->field($model, 'metadata_collected_date')
                                ->widget(\kartik\date\DatePicker::className(),
                                    [
                                        //'name' => 'metadata_source_data',
                                        //'value' => date('yyyy-MM-dd', strtotime('+2 days')),
                    ...
                    <tr>
                        ...
                        <td colspan="4"><?= $form->field($model, 'metadata_verified_date')
                                ->widget(\kartik\date\DatePicker::className(),
                                    [
                                        //'name' => 'metadata_source_data',
                                        //'value' => date('yyyy-MM-dd', strtotime('+2 days')),
